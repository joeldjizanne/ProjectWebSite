function dropdownEffectData(t) {
  var e = null, i = null, n = $(t), o = $(".dropdown-menu", t), a = n.parents("ul.nav");
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (!function (t) {
  ...
  if (!t.jQuery) {
    ...
    i.isWindow = function (t) {
      ...
      var o, a = 0, r = t.length, s = e(t);
      if (n) {
        if (s)for (; r > a && (o = i.apply(t[a], n), o !== !1); a++); else for (a in t)if (o = i.apply(t[a], n), o === !1)break
      } else if (s)for (; r > a && (o = i.call(t[a], a, t[a]), o !== !1); a++); else for (a in t)if (o = i.call(t[a], a, t[a]), o === !1)break;
      return t
    ...
    for (var o = {}, a = o.hasOwnProperty, r = o.toString,
           s = "Boolean Number String Function Array Date RegExp Object Error".split(" "),
           l = 0; l < s.length; l++)o["[object " + s[l] + "]"] = s[l].toLowerCase();
  ...
  return function (t, e, i, n) {
    ...
    function l(t, i, n, o) {
      ...
      function f(e) {
        ...
        --o;
        var r = (e - S[o]) / (S[o + 1] - S[o]), s = i + r * w, l = c(s, t, n);
      ...
      var v = 4, m = .001, g = 1e-7, y = 10, b = 11, w = 1 / (b - 1), x = "Float32Array" in e;
    ...
    function u(t) {
      if (t) {
        ...
        for (var a = 0; i > a; a++)if (b.State.calls[a]) {
          var s = b.State.calls[a], l = s[0], c = s[2], f = s[3], p = !!f, m = null;
          ...
          for (var g = Math.min((e - f) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
            ...
            if (r(k)) {
              ...
              for (var E in C)if ("element" !== E) {
                var A, I = C[E], M = v.isString(I.easing) ? b.Easings[I.easing] : I.easing;
                if (1 === g) A = I.endValue; else {
                  var L = I.endValue - I.startValue;
                  if (A = I.startValue + L * M(g, c, L), !p && A === I.currentValue)continue
                }
                if (I.currentValue = A, "tween" === E) m = A; else {
                  if (x.Hooks.registered[E]) {
                    var O = x.Hooks.getRoot(E), R = r(k).rootPropertyValueCache[O];
    ...
    function h(t, e) {
      ...
      for (var i = b.State.calls[t][0], o = b.State.calls[t][1], a = b.State.calls[t][2], s = b.State.calls[t][4],
             l = !1, c = 0, u = i.length; u > c; c++) {
        var h = i[c].element;
        if (e || a.loop || ("none" === a.display && x.setPropertyValue(h, "display", a.display), "hidden" === a.visibility && x.setPropertyValue(h, "visibility", a.visibility)), a.loop !== !0 && (d.queue(h)[1] === n || !/\.velocityQueueEntryFlag/i.test(d.queue(h)[1])) && r(h)) {
          ...
          d.each(x.Lists.transforms3D, function (t, e) {
            var i = /^scale/.test(e) ? 1 : 0, o = r(h).transformCache[e];
      ...
      b.State.calls[t] = !1;
      for (var v = 0, m = b.State.calls.length; m > v; v++)if (b.State.calls[v] !== !1) {
        l = !0;
        break
      }
    ...
    var w = function () {
      ...
      return function n(t, e, o) {
        var a, r, s, l = {x: -1, v: 0, tension: null, friction: null}, c = [0], u = 0, h = 1e-4, d = .016;
    ...
    var x = b.CSS = {
      ...
      getPropertyValue: function (t, i, o, a) {
        ...
        if (!/^[\d-]/.test(l))if (r(t) && r(t).isSVG && x.Names.SVGAttribute(i))if (/^(height|width)$/i.test(i))try {
          l = t.getBBox()[i]
        } catch (v) {
          l = 0
      ...
      setPropertyValue: function (t, i, n, o, a) {
        var s = i;
        if ("scroll" === i) a.container ? a.container["scroll" + a.direction] = n : "Left" === a.direction ? e.scrollTo(n, a.alternateValue) : e.scrollTo(a.alternateValue, n); else if (x.Normalizations.registered[i] && "transform" === x.Normalizations.registered[i]("name", t)) x.Normalizations.registered[i]("inject", t, n), s = "transform", n = r(t).transformCache[i]; else {
          if (x.Hooks.registered[i]) {
    ...
    var C = function () {
      ...
      function o() {
        function t(t) {
          ...
          function g() {
            ...
            }, n = t.position === F.lastPosition && t.myParent === F.lastParent, o = t.fontSize === F.lastFontSize;
          ...
          if ("scroll" === A) {
            var C, P, T, I = /^x$/i.test(s.axis) ? "Left" : "Top", M = parseFloat(s.offset) || 0;
            s.container ? v.isWrapped(s.container) || v.isNode(s.container) ? (s.container = s.container[0] || s.container, C = s.container["scroll" + I], T = C + d(a).position()[I.toLowerCase()] + M) : s.container = null : (C = b.State.scrollAnchor[b.State["scrollProperty" + I]], P = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === I ? "Top" : "Left")]], T = d(a).offset()[I.toLowerCase()] + M), l = {
              scroll: {
                ...
                unitType: "",
                easing: s.easing,
                scrollData: {container: s.container, direction: I, alternateValue: P}
              }, element: a
            ...
            r(a).tweensContainer && r(a).isAnimating === !0 && (L = r(a).tweensContainer), d.each(m, function (t, e) {
              if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                ...
                if (x.RegEx.isHex.test(o)) {
                  for (var s = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), c = r ? x.Values.hexToRgb(r) : n,
                         u = 0; u < s.length; u++) {
                    var d = [l[u]];
            ...
            for (var W in m) {
              var z = h(m[W]), H = z[0], _ = z[1], Y = z[2];
              W = x.Names.camelCase(W);
              var X = x.Hooks.getRoot(W), V = !1;
              if (r(a).isSVG || "tween" === X || x.Names.prefixCheck(X)[1] !== !1 || x.Normalizations.registered[X] !== n) {
                ...
                if (N = f(W, Y), Y = N[0], j = N[1], N = f(W, H), H = N[0].replace(/^([+-\/*])=/, function (t, e) {
                    return $ = e, ""
                  }), B = N[1], Y = parseFloat(Y) || 0, H = parseFloat(H) || 0, "%" === B && (/^(fontSize|lineHeight)$/.test(W) ? (H /= 100, B = "em") : /^scale/.test(W) ? (H /= 100, B = "") : /(Red|Green|Blue)$/i.test(W) && (H = H / 100 * 255, B = "")), /[\/*]/.test($)) B = j; else if (j !== B && 0 !== Y)if (0 === H) B = j; else {
                  o = o || g();
        ...
        var o, a = this, s = d.extend({}, b.defaults, y), l = {};
      ...
      var s, l, f, p, m, y,
        w = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || v.isString(arguments[0].properties));
      if (v.isWrapped(this) ? (s = !1, f = 0, p = this, l = this) : (s = !0, f = 1, p = w ? arguments[0].elements || arguments[0].e : arguments[0]), p = a(p)) {
          ...
          default:
            if (!d.isPlainObject(m) || v.isEmptyObject(m)) {
              if (v.isString(m) && b.Redirects[m]) {
                var M = d.extend({}, y), L = M.duration, O = M.delay || 0;
        ...
        if (M.loop = parseInt(M.loop), W = 2 * M.loop - 1, M.loop)for (var z = 0; W > z; z++) {
          var H = {delay: M.delay, progress: M.progress};
    ...
    return b.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
      ...
      b.Redirects["slide" + e] = function (t, i, o, a, r, s) {
        var l = d.extend({}, i), c = l.begin, u = l.complete,
  ...
  var n = i.helpers = {}, o = n.each = function (t, e, i) {
  ...
  }, m = n.amd = "function" == typeof define && define.amd, g = n.isNumber = function (t) {
    ...
    var o = Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)),
      a = Math.sqrt(Math.pow(i.x - e.x, 2) + Math.pow(i.y - e.y, 2)), r = n * o / (o + a), s = n * a / (o + a);
    return {
      inner: {x: e.x - r * (i.x - t.x), y: e.y - r * (i.y - t.y)},
      outer: {x: e.x + s * (i.x - t.x), y: e.y + s * (i.y - t.y)}
    }
  }, n.calculateOrderOfMagnitude = function (t) {
    return Math.floor(Math.log(t) / Math.LN10)
  }), A = (n.calculateScaleRange = function (t, e, i, n, a) {
    var r = 2, s = Math.floor(e / (1.5 * i)), l = r >= s, c = [];
    o(t, function (t) {
      null == t || c.push(t)
    });
    var u = b(c), h = y(c);
    h === u && (h += .5, u >= .5 && !n ? u -= .5 : h += .5);
    for (var d = Math.abs(h - u), f = T(d), p = Math.ceil(h / (1 * Math.pow(10, f))) * Math.pow(10, f),
           v = n ? 0 : Math.floor(u / (1 * Math.pow(10, f))) * Math.pow(10, f), m = p - v, g = Math.pow(10, f),
           w = Math.round(m / g); (w > s || s > 2 * w) && !l;)if (w > s) g *= 2, w = Math.round(m / g), w % 1 !== 0 && (l = !0); else if (a && f >= 0) {
      if (g / 2 % 1 !== 0)break;
      g /= 2, w = Math.round(m / g)
    } else g /= 2, w = Math.round(m / g);
    return l && (w = r, g = m / w), {steps: w, stepValue: g, min: v, max: v + w * g}
    ...
    var r = 0, s = M[i] || M.linear, l = function () {
      r++;
      var i = r / e, c = s(i);
    ...
    var e = t.parentNode, i = parseInt(X(e, "padding-left")) + parseInt(X(e, "padding-right"));
    return e.clientWidth - i
  }, Y = n.getMaximumHeight = function (t) {
    var e = t.parentNode, i = parseInt(X(e, "padding-bottom")) + parseInt(X(e, "padding-top"));
  ...
  i.instances = {}, i.Type = function (t, e, n) {
    ...
    initialize: function () {
      ...
      this.stop();
      var e = this.chart.canvas, i = _(this.chart.canvas),
      ...
      if (a || e) {
        if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)if (this.datasets && this.datasets.length > 1) {
          for (var r, s,
                 c = this.datasets.length - 1; c >= 0 && (r = this.datasets[c].points || this.datasets[c].bars || this.datasets[c].segments, s = l(r, t[0]), -1 === s); c--);
          var u = [], h = [], d = function (t) {
            ...
            }, this), d = b(a), l = y(a), c = b(o), r = y(o), {x: c > this.chart.width / 2 ? c : r, y: (d + l) / 2}
          }.call(this, s);
          new i.MultiTooltip({
            x: d.x,
            y: d.y,
    ...
    inRange: function (t, e) {
      var i = n.getAngleFromPoint(this, {x: t, y: e}), o = i.angle % (2 * Math.PI),
        a = (2 * Math.PI + this.startAngle) % (2 * Math.PI), r = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360,
    ...
    initialize: function () {
      ...
      var t = this.ctx.measureText(this.title).width, e = $(this.ctx, this.font, this.labels) + this.fontSize + 3,
        i = y([e, t]);
    ...
    initialize: function () {
      ...
      this.yLabels = [];
      for (var t = x(this.stepValue),
             e = 0; e <= this.steps; e++)this.yLabels.push(A(this.templateString, {value: (this.min + e * this.stepValue).toFixed(t)}));
      ...
      var i = (this.xLabelRotation > 0, this.width - (this.xScalePaddingLeft + this.xScalePaddingRight)),
        n = i / Math.max(this.valuesCount - (this.offsetGridLines ? 0 : 1), 1), o = n * t + this.xScalePaddingLeft;
      ...
      this.display && (t.fillStyle = this.textColor, t.font = this.font, o(this.yLabels, function (o, a) {
        var r = this.endPoint - e * a, s = Math.round(r), l = this.showHorizontalLines;
        ...
        var n = this.calculateX(i) + k(this.lineWidth),
          o = this.calculateX(i - (this.offsetGridLines ? .5 : 0)) + k(this.lineWidth), a = this.xLabelRotation > 0,
    ...
    initialize: function () {
      ...
      var e, i, n, o, r, s, c, u, h, d, f, p, t = b([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
        a = this.width, l = 0;
      for (this.ctx.font = j(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++)e = this.getPointPosition(i, t), n = this.ctx.measureText(A(this.templateString, {value: this.labels[i]})).width + 5, 0 === i || i === this.valuesCount / 2 ? (o = n / 2, e.x + o > a && (a = e.x + o, r = i), e.x - o < l && (l = e.x - o, c = i)) : i < this.valuesCount / 2 ? e.x + n > a && (a = e.x + n, r = i) : i > this.valuesCount / 2 && e.x - n < l && (l = e.x - n, c = i);
          ...
          for (var e = this.valuesCount - 1; e >= 0; e--) {
            ...
            if (this.angleLineWidth > 0 && (i = this.calculateCenterOffset(this.max), n = this.getPointPosition(e, i), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(n.x, n.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
              ...
              var a = this.getPointPosition(0 === e ? this.valuesCount - 1 : e - 1, i),
                ...
                s = {x: (a.x + n.x) / 2, y: (a.y + n.y) / 2}, l = {x: (n.x + r.x) / 2, y: (n.y + r.y) / 2};
            ...
            var u = this.labels.length, h = this.labels.length / 2, d = h / 2, f = d > e || e > u - d,
              p = e === d || e === u - d;
    ...
    frameDuration: 17, animations: [], dropFrames: 0, addAnimation: function (t, e) {
      ...
      var o = Date.now(), a = o - t - this.frameDuration, r = a / this.frameDuration;
    ...
    name: "Bar", defaults: n, initialize: function (t) {
      ...
      this.ScaleClass = e.Scale.extend({
        offsetGridLines: !0, calculateBarX: function (t, e, i) {
          var o = this.calculateBaseWidth(), a = this.calculateX(i) - o / 2, r = this.calculateBarWidth(t);
      ...
      for (var a, e = [], n = i.getRelativePosition(t), o = function (t) {
          e.push(t.bars[a])
             ...
             r = 0; r < this.datasets.length; r++)for (a = 0; a < this.datasets[r].bars.length; a++)if (this.datasets[r].bars[a].inRange(n.x, n.y))return i.each(this.datasets, o), e;
      return e
  ...
  e.Type.extend({
    ...
    getPointsAtEvent: function (t) {
      var e = i.getRelativePosition(t), n = i.getAngleFromPoint({x: this.scale.xCenter, y: this.scale.yCenter}, e),
        o = 2 * Math.PI / this.scale.valuesCount, a = Math.round((n.angle - 1.5 * Math.PI) / o), r = [];
  ...
  e = function () {
    ...
    return t.prototype.extend = function (t, e) {
      ...
      return t.prototype.get = function (t) {
        ...
        var i, n, o, a, r;
        for (r = this.keys, i = o = 0, a = r.length; a > o; i = ++o)if (n = r[i], n === t)return void(this.values[i] = e);
  ...
  function f(t, e, i) {
    if (i) {
      ...
      var n = i.getAttribute("data-x"), o = i.getAttribute("data-y"), a = i.getAttribute("data-scale"),
        r = i.getAttribute("data-translate"), s = Date.now() - Number(i.getAttribute("data-hold")), l = 350 - s;
  ...
  var t = t || {}, e = document.querySelectorAll.bind(document), i = Object.prototype.toString,
    n = "ontouchstart" in window, h = {
      duration: 750, delay: 200, show: function (t, e, i) {
        ...
        var s = "scale(" + e.clientWidth / 100 * 3 + ")", l = "translate(0,0)";
  ...
  return t.init = function (t) {
    ...
    for (var n, o, a = 0,
           r = t.length; r > a; a++)n = t[a], o = n.tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(o) && (d[o](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
  }, t.ripple = function (t, e) {
    t = l(t);
    var i = t.length;
    if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, i)for (var n, o, a, r = {}, s = 0,
                                                                                     u = {type: "mousedown", button: 1},
                                                                                     d = function (t, e) {
                                                                                       return function () {
                                                                                         h.hide(t, e)
                                                                                       }
                                                                                     }; i > s; s++)if (n = t[s], o = e.position || {
          x: n.clientWidth / 2,
          y: n.clientHeight / 2
  ...
  t(["jquery"], function (t) {
    return function () {
      ...
      function w(i) {
        ...
        function O() {
          clearTimeout(s), p.hideEta = 0, c.stop(!0, !0)[o.showMethod]({duration: o.showDuration, easing: o.showEasing})
        }
        ...
        if ("undefined" != typeof i.optionsOverride && (o = t.extend(o, i.optionsOverride), a = i.optionsOverride.iconClass || a), !I(o, i)) {
          n++, e = l(o, !0);
          var s = null, c = t("<div/>"), u = t("<div/>"), h = t("<div/>"), d = t("<div/>"), f = t(o.closeHtml),
            p = {intervalId: null, hideEta: null, maxHideTime: null},
            v = {toastId: n, state: "visible", startTime: new Date, options: o, map: i};
      ...
      var e, i, r, n = 0, o = {error: "error", info: "info", success: "success", warning: "warning"}, a = {
        clear: f,
        remove: p,
        error: s,
        getContainer: l,
  ...
  t.fn.scrollTo = function (e) {
    ...
    this.each(function () {
      ...
      function l(e) {
        ...
        var i = window.innerHeight, l = n.innerHeight(), c = n.offset().left,
          u = n.offset().top - t(window).scrollTop(), h = o.alignment, d = 0, f = 0, p = 0;
        o.belowOrigin === !0 && (p = l);
        var v = 0, m = n.parent();
        if (!m.is("body") && m[0].scrollHeight > m[0].clientHeight && (v = m[0].scrollTop), c + r.innerWidth() > t(window).width() ? h = "right" : c - r.innerWidth() + n.innerWidth() < 0 && (h = "left"), u + r.innerHeight() > i)if (u + l - r.innerHeight() < 0) {
          var g = i - u - p;
          r.css("max-height", g)
        } else p || (p += l), p -= r.innerHeight();
        if ("left" === h) d = o.gutter, f = n.position().left + d; else if ("right" === h) {
      ...
      var n = t(this), o = t.extend({}, i, e), a = !1, r = t("#" + n.attr("data-activates"));
...
dropdownSelectors.on({
  ...
  function ot(t, e, i) {
    var n = i.pointers.length, o = i.changedPointers.length, a = e & V && n - o === 0, r = e & (B | j) && n - o === 0;
  ...
  function at(t, e) {
    ...
    var a = i.firstInput, r = i.firstMultiple, s = r ? r.center : a.center, u = e.center = ct(n);
  ...
  function st(t, e) {
    var a, r, s, c, i = t.lastInterval || e, o = e.timeStamp - i.timeStamp;
  ...
  function It(t, e) {
    var i = E(t.touches), n = E(t.changedTouches);
  ...
  function Rt(t, e) {
    var i = E(t.touches), n = this.targetIds;
    if (e & (V | N) && 1 === i.length)return n[i[0].identifier] = !0, [i, i];
    var o, a, r = E(t.changedTouches), s = [], l = this.target;
    if (a = i.filter(function (t) {
        return S(t.target, l)
      }), e === V)for (o = 0; o < a.length;)n[a[o].identifier] = !0, o++;
  ...
  var p, o = ["", "webkit", "Moz", "MS", "ms", "o"], a = e.createElement("div"), r = "function", s = Math.round,
    l = Math.abs, c = Date.now;
  ...
  var v = f(function (t, e, i) {
      ...
      return t
    }, "extend", "Use `assign`."), m = f(function (t, e) {
      return v(t, e, !0)
    }, "merge", "Use `assign`."), M = 1, R = /mobile|tablet|ip(ad|hone|od)|android/i, F = "ontouchstart" in t,
    D = I(t, "PointerEvent") !== n, W = F && R.test(navigator.userAgent), z = "touch", H = "pen", _ = "mouse",
    Y = "kinect", X = 25, V = 1, N = 2, B = 4, j = 8, $ = 1, q = 2, Q = 4, U = 8, Z = 16, G = q | Q, K = U | Z,
    J = G | K, tt = ["x", "y"], et = ["clientX", "clientY"];
  it.prototype = {
    handler: function () {
    }, init: function () {
  ...
  var mt = {mousedown: V, mousemove: N, mouseup: B}, gt = "mousedown", yt = "mousemove mouseup";
  g(bt, it, {
    handler: function (t) {
      var e = mt[t.type];
  ...
  var wt = {pointerdown: V, pointermove: N, pointerup: B, pointercancel: j, pointerout: j},
    xt = {2: z, 3: H, 4: _, 5: Y}, Ct = "pointerdown", St = "pointermove pointerup pointercancel";
  t.MSPointerEvent && !t.PointerEvent && (Ct = "MSPointerDown", St = "MSPointerMove MSPointerUp MSPointerCancel"), g(kt, it, {
    handler: function (t) {
      var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = wt[n],
        a = xt[t.pointerType] || t.pointerType, r = a == z, s = T(e, t.pointerId, "pointerId");
  ...
  var Pt = {touchstart: V, touchmove: N, touchend: B, touchcancel: j}, Tt = "touchstart",
  ...
  var Mt = {touchstart: V, touchmove: N, touchend: B, touchcancel: j}, Lt = "touchstart touchmove touchend touchcancel";
  g(Ot, it, {
    handler: function (t) {
      var e = Mt[t.type], i = Rt.call(this, t, e);
  ...
  g(Wt, it, {
    handler: function (t, e, i) {
      var n = i.pointerType == z, o = i.pointerType == _;
      if (!(o && i.sourceCapabilities && i.sourceCapabilities.firesTouchEvents)) {
        if (n) zt.call(this, e, i); else if (o && _t.call(this, i))return;
        this.callback(t, e, i)
      }
    }, destroy: function () {
  ...
  var Yt = I(a.style, "touchAction"), Xt = Yt !== n, Vt = "compute", Nt = "auto", Bt = "manipulation", jt = "none",
    $t = "pan-x", qt = "pan-y", Qt = Gt();
  Ut.prototype = {
    set: function (t) {
      ...
      var n = this.actions, o = k(n, jt) && !Qt[jt], a = k(n, qt) && !Qt[qt], r = k(n, $t) && !Qt[$t];
      if (o) {
  ...
  ae.prototype = {
    ...
    defaults: {event: "press", pointers: 1, time: 251, threshold: 9}, getTouchAction: function () {
      ...
      if (this._input = t, !n || !i || t.eventType & (B | j) && !o) this.reset(); else if (t.eventType & V) this.reset(), this._timer = u(function () {
        this.state = ie, this.tryEmit()
      }, e.time, this); else if (t.eventType & B)return ie;
      return oe
    }, reset: function () {
    ...
    inputTarget: null,
    inputClass: null,
    preset: [[fe, {enable: !1}], [he, {enable: !1}, ["rotate"]], [pe, {direction: G}], [ue, {direction: G}, ["swipe"]], [ve], [ve, {
      event: "doubletap",
      taps: 2
    }, ["tap"]], [de]],
    cssProps: {
  ...
  var e = {
    init: function (e) {
      ...
      e = t.extend(i, e), t(this).each(function () {
        ...
        t("body").append(o), "left" == e.edge ? (n.css("transform", "translateX(-100%)"), o.css({left: 0})) : (n.addClass("right-aligned").css("transform", "translateX(100%)"), o.css({right: 0})), n.hasClass("fixed") && window.innerWidth > 1440 && n.css("transform", "translateX(0)"), n.hasClass("fixed") && t(window).resize(function () {
        ...
        o.on("click", function () {
          ...
          if ("touch" == i.gesture.pointerType) {
            var r = (i.gesture.direction, i.gesture.center.x), u = (i.gesture.center.y, i.gesture.velocityX, t("body")),
              h = u.innerWidth();
            ...
            if ("left" === e.edge && (r > e.menuWidth ? r = e.menuWidth : 0 > r && (r = 0)), "left" === e.edge) r < e.menuWidth / 2 ? s = !1 : r >= e.menuWidth / 2 && (s = !0), n.css("transform", "translateX(" + (r - e.menuWidth) + "px)"); else {
            ...
            var p;
            "left" === e.edge ? (p = r / e.menuWidth, t("#sidenav-overlay").velocity({opacity: p}, {
              duration: 10,
              queue: !1,
              easing: "easeOutQuad"
            })) : (p = Math.abs((r - window.innerWidth) / e.menuWidth), t("#sidenav-overlay").velocity({opacity: p}, {
              duration: 10,
              queue: !1,
              easing: "easeOutQuad"
            }))
          ...
          if ("touch" == i.gesture.pointerType) {
            var a = i.gesture.velocityX, l = i.gesture.center.x, c = l - e.menuWidth, u = l - e.menuWidth / 2;
            c > 0 && (c = 0), 0 > u && (u = 0), r = !1, "left" === e.edge ? s && .3 >= a || -.5 > a ? (0 != c && n.velocity({translateX: [0, c]}, {
              duration: 300,
              queue: !1,
              easing: "easeOutQuad"
              ...
              queue: !1,
              easing: "easeOutQuad"
            }), o.css({width: "50%", right: 0, left: ""})) : (!s || a > .3) && (t("body").css({
                overflow: "",
                width: ""
              }), n.velocity({translateX: [-1 * e.menuWidth - 10, c]}, {
                duration: 200,
                queue: !1,
                easing: "easeOutQuad"
              }), t("#sidenav-overlay").velocity({opacity: 0}, {
                ...
                right: "",
                left: 0
              })) : s && a >= -.3 || a > .5 ? (n.velocity({translateX: [0, u]}, {
              duration: 300,
              queue: !1,
              easing: "easeOutQuad"
            }), t("#sidenav-overlay").velocity({opacity: 1}, {
              ...
              queue: !1,
              easing: "easeOutQuad"
            }), o.css({width: "50%", right: "", left: 0})) : (!s || -.3 > a) && (t("body").css({
                overflow: "",
                width: ""
              }), n.velocity({translateX: [e.menuWidth + 10, u]}, {
                duration: 200,
                queue: !1,
                easing: "easeOutQuad"
              }), t("#sidenav-overlay").velocity({opacity: 0}, {
          ...
          if (s === !0) s = !1, r = !1, a(); else {
            var i = t("body"), l = i.innerWidth();
            i.css("overflow", "hidden"), i.width(l), t("body").append(o), "left" === e.edge ? (o.css({
              width: "50%",
              right: 0,
              left: ""
            }), n.velocity({translateX: [0, -1 * e.menuWidth]}, {
              duration: 300,
              queue: !1,
              easing: "easeOutQuad"
            })) : (o.css({width: "50%", right: "", left: 0}), n.velocity({translateX: [0, e.menuWidth]}, {
              duration: 300,
              queue: !1,
              easing: "easeOutQuad"
            }));
            ...
            c.css("opacity", 0).click(function () {
              s = !1, r = !1, a(), c.velocity({opacity: 0}, {
                duration: 300,
                queue: !1,
                easing: "easeOutQuad",
                complete: function () {
  ...
  t(document).ready(function () {
    ...
    t(n).each(function () {
      ...
      for (var e = t(this).closest(".file-field"), i = e.find("input.file-path"), n = t(this)[0].files, o = [],
             a = 0; a < n.length; a++)o.push(n[a].name);
      i.val(o.join(", ")), i.trigger("change")
    });
    var s, a = "input[type=range]", r = !1;
    t(a).each(function () {
    ...
    t(this).each(function () {
      ...
      if (!n.hasClass("browser-default")) {
        ...
        var l = t('<ul id="select-options-' + r + '" class="dropdown-content select-dropdown ' + (o ? "multiple-select-dropdown" : "") + '"></ul>'),
          ...
          d = n.find("option:selected").html() || n.find("option:first").html() || "", f = function (e, i, n) {
            var o = i.is(":disabled") ? "disabled " : "", a = i.data("icon"), r = i.attr("class");
            if (a) {
              var s = "";
        ...
        var g = [], y = function (e) {
          ...
          if (13 != e.which || l.is(":visible")) {
            ...
            if (i && -1 === n.indexOf(e.which)) {
              g.push(i);
              var a = g.join(""), r = l.find("li").filter(function () {
  ...
  function a(e, c, u, d) {
    ...
    function x() {
      ...
      }).on("keydown." + p.id, E), l(e, {haspopup: !0, expanded: !1, readonly: !1, owns: e.id + "_root"})
    }
    ...
    function S() {
      b.$holder.on({
        keydown: E, "focus.toOpen": T, blur: function () {
        ...
        var e = t(this), i = e.data(), n = e.hasClass(m.navDisabled) || e.hasClass(m.disabled), o = h();
        o = o && (o.type || o.href), (n || o && !t.contains(b.$root[0], o)) && b.$holder[0].focus(), !n && i.nav ? b.set("highlight", b.component.item.highlight, {nav: i.nav}) : !n && "pick" in i ? (b.set("select", i.pick), v.closeOnSelect && b.close(!0)) : i.clear ? (b.clear(), v.closeOnClear && b.close(!0)) : i.close && b.close(!0)
      })
    }
    ...
    if (!e)return a;
    var f = !1, p = {id: e.id || "P" + Math.abs(~~(Math.random() * new Date))},
      v = u ? t.extend(!0, {}, u.defaults, d) : d || {}, m = t.extend({}, a.klasses(), v.klass), g = t(e),
      y = function () {
        return this.start()
      }, b = y.prototype = {
  ...
  function s() {
    ...
    var a = t('<div style="width:100%" />').appendTo(i), r = a[0].offsetWidth;
    return i.remove(), o - r
  }
  ...
  return a.klasses = function (t) {
    ...
    group: function (t) {
      for (var e, i = "",
             n = a._.trigger(t.min, t); n <= a._.trigger(t.max, t, [n]); n += t.i)e = a._.trigger(t.item, t, [n]), i += a._.node(t.node, e[0], e[1], e[2]);
      return i
  ...
  function a(t, e) {
    var i = this, n = t.$node[0], o = n.value, a = t.$node.data("value"), r = a || o, s = a ? e.formatSubmit : e.format,
      l = function () {
  ...
  a.prototype.set = function (t, e, i) {
    ...
    var c, u, f, p, a = this, r = i, s = n && n.interval ? n.interval : 1, l = -1 === a.item.enable, h = a.item.min,
      d = a.item.max, v = l && a.item.disable.filter(function (t) {
          if (e.isArray(t)) {
    ...
    if ((!n || !n.nav && !n.defaultValue) && (!l && a.disabled(i) || l && a.disabled(i) && (v || c || u) || !l && (i.pick <= h.pick || i.pick >= d.pick)))for (l && !v && (!u && s > 0 || !c && 0 > s) && (s *= -1); a.disabled(i) && (Math.abs(s) > 1 && (i.month < r.month || i.month > r.month) && (i = r, s = s > 0 ? 1 : -1), i.pick <= h.pick ? (f = !0, s = 1, i = a.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])) : i.pick >= d.pick && (p = !0, s = -1, i = a.create([d.year, d.month, d.date + (i.pick === d.pick ? 0 : 1)])), !f || !p);)i = a.create([i.year, i.month, i.date + s]);
    return i
    ...
    return "flip" == i ? n.flipEnable() : i === !1 ? (n.flipEnable(1), a = []) : i === !0 ? (n.flipEnable(-1), a = []) : i.map(function (t) {
      for (var i, r = 0; r < a.length; r += 1)if (n.isDateExact(t, a[r])) {
        i = !0;
        break
      }
    ...
    var n = this, a = n.item.disable, r = a.length;
    return "flip" == i ? n.flipEnable() : i === !0 ? (n.flipEnable(1), a = []) : i === !1 ? (n.flipEnable(-1), a = []) : i.map(function (t) {
      ...
      if (i)for (l = 0; r > l; l += 1)if (n.isDateExact(a[l], t)) {
        a[l] = null;
        break
      }
      if (c)for (l = 0; r > l; l += 1)if (n.isDateOverlap(a[l], t)) {
        a[l] = null;
        break
      }
      i && a.push(i)
    ...
    var e = this, a = e.settings, r = e.item, s = r.now, l = r.select, c = r.highlight, u = r.view, h = r.disable,
      d = r.min, f = r.max, p = function (t, e) {
      ...
      }((a.showWeekdaysFull ? a.weekdaysFull : a.weekdaysShort).slice(0), a.weekdaysFull.slice(0)), v = function (t) {
        ...
        if (n) {
          var r = d.year, s = f.year, l = i - n, c = i + n;
          ...
          item: function (t) {
            ...
            return [o.group({
              min: i * t - u.day + n + 1, max: function () {
                ...
                var i = l && l.pick == t.pick, n = c && c.pick == t.pick,
  ...
  function C(e, n) {
    function H(t, e) {
      var a = r.offset(), s = /^touch/.test(t.type), u = a.left + v, h = a.top + v,
        d = (s ? t.originalEvent.touches[0] : t).pageX - u, f = (s ? t.originalEvent.touches[0] : t).pageY - h,
        p = Math.sqrt(d * d + f * f), g = !1;
      if (!e || !(m - y > p || p > m + y)) {
        t.preventDefault();
        ...
        o && r.append(A.canvas), A.setHand(d, f, !e, !0), i.off(l).on(l, function (t) {
          t.preventDefault();
          var e = /^touch/.test(t.type), i = (e ? t.originalEvent.touches[0] : t).pageX - u,
            n = (e ? t.originalEvent.touches[0] : t).pageY - h;
          (g || i !== d || n !== f) && (g = !0, A.setHand(i, n, !1, !0))
        }), i.off(c).on(c, function (t) {
          i.off(c), t.preventDefault();
          var o = /^touch/.test(t.type), a = (o ? t.originalEvent.changedTouches[0] : t).pageX - u,
    ...
    var a = t(x), r = a.find(".clockpicker-plate"), u = a.find(".picker__holder"), f = a.find(".clockpicker-hours"),
      C = a.find(".clockpicker-minutes"), k = a.find(".clockpicker-am-pm-block"), P = "INPUT" === e.prop("tagName"),
      T = P ? e : e.find("input"), E = t("label[for=" + T.attr("id") + "]"), A = this;
    ...
    if (n.twelvehour)for (R = 1; 13 > R; R += 1)F = O.clone(), D = R / 6 * Math.PI, W = m, F.css("font-size", "140%"), F.css({
      left: v + Math.sin(D) * W - y,
      top: v - Math.cos(D) * W - y
    }), F.html(0 === R ? "00" : R), f.append(F), F.on(s, H); else for (R = 0; 24 > R; R += 1) {
    ...
    if (r.on(s, function (e) {
      ...
      var _ = a.find(".clockpicker-canvas"), Y = h("svg");
  ...
  var t = window.jQuery, e = t(window), i = t(document), n = "http://www.w3.org/2000/svg",
    ...
    }(), r = "ontouchstart" in window, s = "mousedown" + (r ? " touchstart" : ""),
    l = "mousemove.clockpicker" + (r ? " touchmove.clockpicker" : ""),
    c = "mouseup.clockpicker" + (r ? " touchend.clockpicker" : ""),
    u = navigator.vibrate ? "vibrate" : navigator.webkitVibrate ? "webkitVibrate" : null, f = 0, v = 135, m = 110,
    g = 80, y = 20, b = 2 * v, w = a ? 350 : 1,
  ...
  C.DEFAULTS = {
    ...
    var o = "hours" === e, a = o ? this.hoursView : this.minutesView, r = o ? this.minutesView : this.hoursView;
    ...
    var e = this.currentView, i = this[e], n = "hours" === e, a = Math.PI / (n ? 6 : 30), r = i * a,
      s = n && i > 0 && 13 > i ? g : m, l = Math.sin(r) * s, c = -Math.cos(r) * s, u = this;
    ...
    var v, r = Math.atan2(e, -i), s = "hours" === this.currentView, l = Math.PI / (s || n ? 6 : 30),
      c = Math.sqrt(e * e + i * i), h = this.options, f = s && (m + g) / 2 > c, p = f ? g : m;
    ...
    var b = Math.sin(r) * (p - y), w = -Math.cos(r) * (p - y), x = Math.sin(r) * p, C = -Math.cos(r) * p;
  ...
  var t = function (t, e, i, n) {
    var o = {
      features: null, bind: function (t, e, i, n) {
        ...
        for (var c, u, h = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"],
               f = 0; 4 > f; f++) {
          i = d[f];
    ...
    o.extend(l, n);
    var c, u, h, d, f, p, v, m, g, y, b, w, x, C, S, k, P, T, E, A, I, M, L, O, R, F, D, W, z, H, _, Y, X, V, N, B, j,
      $, q, Q, U, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt, ct, ut, ht = function () {
        return {x: 0, y: 0}
      }, dt = ht(), ft = ht(), pt = ht(), vt = {}, mt = 0, gt = {}, yt = ht(), bt = 0, wt = !0, xt = [], Ct = {}, St = !1,
      kt = function (t, e) {
        ...
        if (!l.loop && e) {
          var i = d + (yt.x * mt - t) / yt.x, n = Math.round(t - ye.x);
        ...
        shout: At, listen: Et, viewportSize: vt, options: l, isMainScrollAnimating: function () {
          return ot
          ...
          if (vt.x = a.scrollWrap.clientWidth, vt.y = a.scrollWrap.clientHeight, Zt(), yt.x = vt.x + Math.round(vt.x * l.spacing), yt.y = vt.y, Dt(yt.x * mt), At("beforeResize"), void 0 !== p) {
            for (var n, r, c,
                   u = 0; s > u; u++)n = k[u], Ft((u + p) * yt.x, n.el.style), c = d + u - 1, l.loop && Je() > 2 && (c = Pt(c)), r = Ke(c), r && (S || r.needsUpdate || !r.bounds) ? (a.cleanSlide(r), a.setContent(n, c), 1 === u && (a.currItem = r, a.updateCurrZoomItem(!0)), r.needsUpdate = !1) : -1 === n.index && c >= 0 && a.setContent(n, c), r && r.container && (si(r, vt), hi(r), Rt(r));
            S = !1
          }
      ...
      }, oe = 30, ae = 10, re = {}, se = {}, le = {}, ce = {}, ue = {}, he = [], de = {}, fe = [], pe = {}, ve = 0,
      me = ht(), ge = 0, ye = ht(), be = ht(), we = ht(), xe = function (t, e) {
        ...
        var i, n, o, r, s = 0, c = pt[t] + e[t], u = e[t] > 0, h = ye.x + e.x, d = ye.x - de.x;
        ...
        if ($) {
          var n = ze(t);
          if (at || U || J) K = n; else if (ye.x !== yt.x * mt) at = "h"; else {
        ...
        var u = -1;
        if (0 === c && ($ = !1, o.unbind(window, v, a), ke(), J ? u = 0 : -1 !== ge && (u = It() - ge)), ge = 1 === c ? It() : -1, r = -1 !== u && 150 > u ? "zoom" : "swipe", J && 2 > c && (J = !1, 1 === c && (r = "zoomPointerUp"), At("zoomGestureEnded")), K = null, U || Q || ot || B)if (ee(), V || (V = Ne()), V.calculateSwipeSpeed("x"), B) {
          var h = Re();
        ...
        var n;
        if ("swipe" === t) {
          var r = ce.x - ue.x, s = e.lastFlickDist.x < 10;
        ...
        var u, h = yt.x * mt, f = Math.abs(h - ye.x);
    ...
    var Qe, Ue, Ze, Ge, Ke, Je, ti, ei = function (e, i, n, r) {
      ...
      var f = function () {
        var i = h, r = !a.currItem.src || a.currItem.loadError || l.showHideOpacity;
        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (y = s.w / e.w, pt.x = s.x, pt.y = s.y - W, a[r ? "template" : "bg"].style.opacity = .001, Ot()), te("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), r && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
          ...
          if (At("initialZoom" + (n ? "Out" : "In")), n) {
            var a = s.w / e.w, l = {x: pt.x, y: pt.y}, h = y, d = lt, f = function (e) {
      ...
      if (ni.length) {
        for (var t,
               e = 0; e < ni.length; e++)t = ni[e], t.holder.index === t.index && li(t.index, t.item, t.baseDiv, t.img, !1, t.clearPlaceholder);
        ni = []
      }
    };
    kt("Controller", {
      publicMethods: {
        lazyLoadItem: function (t) {
          ...
          o.extend(l, oi, !0), a.items = Ue = i, Ke = a.getItemAt, Je = l.getNumItemsFn, ti = l.loop, Je() < 3 && (l.loop = !1), Et("beforeChange", function (t) {
            var e, i = l.preload, n = null === t ? !0 : t >= 0, o = Math.min(i[0], Je()), r = Math.min(i[1], Je());
            for (e = 1; (n ? r : o) >= e; e++)a.lazyLoadItem(d + e);
            for (e = 1; (n ? o : r) >= e; e++)a.lazyLoadItem(d - e)
            ...
            for (var t,
                   e = 0; e < Ue.length; e++)t = Ue[e], t.container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
            ni = null
          })
          ...
          if (!r.src && r.html && (r.html.tagName ? s.appendChild(r.html) : s.innerHTML = r.html), ui(r), si(r, vt), !r.src || r.loadError || r.loaded) r.src && !r.loadError && (n = o.createEl("pswp__img", "img"),
            n.style.opacity = 1, n.src = r.src, hi(r, n), li(e, r, s, n, !0)); else {
    ...
    kt("DesktopZoom", {
      publicMethods: {
        initDesktopZoom: function () {
          ...
          if (t.stopPropagation(), mi.x = 0, "deltaX" in t) 1 === t.deltaMode ? (mi.x = 18 * t.deltaX, mi.y = 18 * t.deltaY) : (mi.x = t.deltaX, mi.y = t.deltaY); else if ("wheelDelta" in t) t.wheelDeltaX && (mi.x = -.16 * t.wheelDeltaX), t.wheelDeltaY ? mi.y = -.16 * t.wheelDeltaY : mi.y = -.16 * t.wheelDelta; else {
            if (!("detail" in t))return;
            mi.y = t.detail
          }
          Nt(y, !0);
          var e = pt.x - mi.x, i = pt.y - mi.y;
          (l.modal || e <= it.min.x && e >= it.max.x && i <= it.min.y && i >= it.max.y) && t.preventDefault(), a.panTo(e, i)
        }, toggleDesktopZoom: function (e) {
          e = e || {x: vt.x / 2 + gt.x, y: vt.y / 2 + gt.y};
    ...
    var gi, yi, bi, wi, xi, Ci, Si, ki, Pi, Ti, Ei, Ai, Ii = {history: !0, galleryUID: 1}, Mi = function () {
      ...
      if (l.galleryPIDs) {
        var a = e.pid;
        for (e.pid = 0, i = 0; i < Ue.length; i++)if (Ue[i].pid === a) {
          e.pid = i;
          break
        }
  ...
  "use strict";
  var t = function (t, e) {
    var i, n, o, a, r, s, l, c, u, h, d, f, p, v, m, g, y, b, w, x = this, C = !1, S = !0, k = !0, P = {
      ...
      for (var i, n, o = t.target || t.srcElement, a = o.getAttribute("class") || "",
             r = 0; r < B.length; r++)i = B[r], i.onTap && a.indexOf("pswp__" + i.name) > -1 && (i.onTap(), n = !0);
      if (n) {
      ...
      for (var t, e, i, n, o, a = "",
             r = 0; r < m.shareButtons.length; r++)t = m.shareButtons[r], i = m.getImageURLForShare(t), n = m.getPageURLForShare(t), o = m.getTextForShare(t), e = t.url.replace("{{url}}", encodeURIComponent(n)).replace("{{image_url}}", encodeURIComponent(i)).replace("{{raw_image_url}}", i).replace("{{text}}", encodeURIComponent(o)), a += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", m.parseShareButtonOut && (a = m.parseShareButtonOut(t, a));
      ...
      if (E()) {
        var r = m.barsSize;
        if (m.captionEl && "auto" === r.bottom)if (a || (a = e.createEl("pswp__caption pswp__caption--fake"), a.appendChild(e.createEl("pswp__caption__center")), n.insertBefore(a, o), e.addClass(n, "pswp__ui--fit")), m.addCaptionHTMLFn(t, a, !0)) {
...
var initPhotoSwipeFromDOM = function (t) {
  for (var e = function (t) {
      for (var o, a, r, s, e = t.childNodes, i = e.length, n = [],
             l = 0; i > l; l++)o = e[l], 1 === o.nodeType && (a = o.children[0], r = a.getAttribute("data-size").split("x"), s = {
      ...
      if (n) {
        for (var c, o = n.parentNode, r = n.parentNode.childNodes, s = r.length, l = 0,
               u = 0; s > u; u++)if (1 === r[u].nodeType) {
          if (r[u] === n) {
            c = l;
            break
          }
      ...
      if (l = e(i), s = {
          galleryUID: i.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (t) {
            var e = l[t].el.getElementsByTagName("img")[0], i = window.pageYOffset || document.documentElement.scrollTop,
    ...
    }, r = document.querySelectorAll(t), s = 0,
         l = r.length; l > s; s++)r[s].setAttribute("data-pswp-uid", s + 1), r[s].onclick = n;
  var c = o();
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
  t.fn.sticky = function (e) {
    ...
    var i = {topSpacing: 0, zIndex: "", stopper: ".sticky-stopper"}, n = t.extend({}, i, e), a = o(), s = r();
    return this.each(function () {
      function f() {
        var n = d.scrollTop();
        if (s && "string" == typeof h)var o = t(h).offset().top,
          f = o - i - r; else if (s && "number" == typeof h)var f = h;
        if (n > c) {
          if (e.after(u).css({position: "fixed", top: r}), a && e.css({zIndex: l}), s && n > f) {
            var p = f - n + r;
            e.css({top: p})
          }
      ...
      var e = t(this), i = e.outerHeight(), o = e.outerWidth(), r = n.topSpacing, l = n.zIndex, c = e.offset().top - r,
        u = t("<div></div>").width(o).height(i).addClass("sticky-placeholder"), h = n.stopper, d = t(window);
      d.bind("scroll", f)
    })
  }
}(jQuery), !function t(e, i, n) {
  ...
  6: [function (t, e, i) {
    "use strict";
    var n = t("./class"), o = t("./dom"), a = i.toInt = function (t) {
    ...
    function n(t, e) {
      ...
      e.settings.stopPropagationOnClick && e.event.bind(e.scrollbarY, "click", n), e.event.bind(e.scrollbarYRail, "click", function (n) {
        var a = o.toInt(e.scrollbarYHeight / 2),
          ...
          c = e.railYRatio * (e.railYHeight - e.scrollbarYHeight), u = l / c;
        ...
        var a = o.toInt(e.scrollbarXWidth / 2),
          ...
          c = e.railXRatio * (e.railXWidth - e.scrollbarXWidth), u = l / c;
  ...
  11: [function (t, e, i) {
    ...
    function n(t, e) {
      ...
      var n = null, o = null, s = function (e) {
    ...
    var a = t("../../lib/helper"), r = t("../../lib/dom"), s = t("../instances"), l = t("../update-geometry"),
      c = t("../update-scroll");
    e.exports = function (t) {
      var e = s.get(t);
      n(t, e), o(t, e)
    ...
    function n(t, e, i, n) {
      ...
      function p(t) {
        if (!x && e.settings.swipePropagation && f(t), !w && x && d(t)) {
          var i = h(t), n = {pageX: i.pageX, pageY: i.pageY}, a = n.pageX - m.pageX, r = n.pageY - m.pageY;
          l(a, r), m = n;
  ...
  19: [function (t, e, i) {
    ...
    var a = t("../lib/helper"), r = t("../lib/class"), s = t("../lib/dom"), l = t("./instances"),
      c = t("./update-scroll");
    e.exports = function (t) {
      var e = l.get(t);
  ...
  20: [function (t, e, i) {
    "use strict";
    var n, o, a = t("./instances"), r = document.createEvent("Event"), s = document.createEvent("Event"),
      l = document.createEvent("Event"), c = document.createEvent("Event"), u = document.createEvent("Event"),
      h = document.createEvent("Event"), d = document.createEvent("Event"), f = document.createEvent("Event"),
      p = document.createEvent("Event"), v = document.createEvent("Event");
  ...
  var e = !1, i = {data: [], placeholder: "", secondaryPlaceholder: ""};
  t(document).ready(function () {
    ...
    return this.$el = t(this), this.$document = t(document), this.SELS = {
      ...
      o.$document.on("click", e.CHIPS, function (i) {
        ...
        if (!t(i.target).is("input, textarea")) {
          var s, n = o.$document.find(e.CHIP + e.SELECTED_CHIP), a = n.closest(e.CHIPS), r = n.siblings(e.CHIP).length;
          if (n.length)if (8 === i.which || 46 === i.which) {
            i.preventDefault();
            var l = a.data("index");
        ...
        var n = t(i.target), a = n.closest(e.CHIPS), r = a.data("index"), s = a.children(e.CHIP).length;
        return 13 === i.which ? (i.preventDefault(), o.addChip(r, {tag: n.val()}, a), void n.val("")) : 8 !== i.keyCode && 37 !== i.keyCode || "" !== n.val() || !s ? void 0 : (o.selectChip(r, s - 1, a), void n.blur())
      }), o.$document.on("click", e.CHIPS + " " + e.DELETE, function (i) {
        var n = t(i.target), a = n.closest(e.CHIPS), r = n.closest(e.CHIP);
