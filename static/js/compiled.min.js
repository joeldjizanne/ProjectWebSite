...
function get_social_counts() {
  ...
  $.ajax({
    ...
    dataType: "json",
    success: function (t) {
      var e = document.getElementById("dom-target-fb"), n = e.textContent, e = document.getElementById("dom-target-tw"),
        i = e.textContent, e = document.getElementById("dom-target-gp"), o = e.textContent,
        r = 1 * n.valueOf() + t.facebook, a = 1 * i.valueOf() + t.twitter, s = 1 * o.valueOf() + t.gplus;
...
if (function (t, e) {
    ...
    function m(t, e) {
      for (var n, i, o = [], r = 0,
             a = t.length; r < a; r++)i = t[r], i.style && (n = i.style.display, e ? ("none" === n && (o[r] = It.get(i, "display") || null, o[r] || (i.style.display = "")), "" === i.style.display && Rt(i) && (o[r] = g(i))) : "none" !== n && (o[r] = "none", It.set(i, "display", n)));
    ...
    function b(t, e, n, i, o) {
      for (var r, a, s, l, c, u, h = e.createDocumentFragment(), d = [], f = 0,
             p = t.length; f < p; f++)if ((r = t[f]) || 0 === r)if ("object" === ft.type(r)) ft.merge(d, r.nodeType ? [r] : r); else if (qt.test(r)) {
    ...
    function I(t, e, n) {
      for (var i, o = e ? ft.filter(e, t) : t,
             r = 0; null != (i = o[r]); r++)n || 1 !== i.nodeType || ft.cleanData(v(i)), i.parentNode && (n && ft.contains(i.ownerDocument, i) && y(v(i, "script")), i.parentNode.removeChild(i));
      return t
    }
    ...
    function z(t, e, n) {
      for (var i, o = (q.tweeners[e] || []).concat(q.tweeners["*"]), r = 0,
             a = o.length; r < a; r++)if (i = o[r].call(n, e, t))return i
    }
    ...
    function q(t, e, n) {
      var i, o, r = 0, a = q.prefilters.length, s = ft.Deferred().always(function () {
        ...
        if (o)return !1;
        for (var e = se || H(), n = Math.max(0, c.startTime + c.duration - e), i = n / c.duration || 0, r = 1 - i,
               a = 0, l = c.tweens.length; a < l; a++)c.tweens[a].run(r);
    ...
    function Z(t, e, n) {
      for (var i, o, r, a, s = t.contents,
             l = t.dataTypes; "*" === l[0];)l.shift(), void 0 === i && (i = t.mimeType || e.getResponseHeader("Content-Type"));
    ...
    ft.fn = ft.prototype = {
      ...
      expando: "jQuery" + ("3.1.1" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (t) {
        throw new Error(t)
      }, noop: function () {
    ...
    var gt = function (t) {
      ...
      function g(t, e, n, i, o) {
        for (var r, a = [], s = 0, l = t.length,
               c = null != e; s < l; s++)(r = t[s]) && (n && !n(r, i, o) || (a.push(r), c && e.push(s)));
        return a
      }
      ...
      function v(t) {
        for (var e, n, i, o = t.length, r = x.relative[t[0].type], a = r || x.relative[" "], s = r ? 1 : 0,
               l = d(function (t) {
                 return t === e
               }, a, !0), c = d(function (t) {
            return K(e, t) > -1
      ...
      var b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W = "sizzle" + 1 * new Date, H = t.document, j = 0,
        z = 0, V = n(), B = n(), q = n(), Y = function (t, e) {
          return t === e && (P = !0), 0
    ...
    var Ft = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Nt = new RegExp("^(?:([+-])=|)(" + Ft + ")([a-z%]*)$", "i"),
      Mt = ["Top", "Right", "Bottom", "Left"], Rt = function (t, e) {
    ...
    ft.extend({
      ...
      ft.fn[t] = function (t) {
        for (var n, i = [], o = ft(t), r = o.length - 1,
               a = 0; a <= r; a++)n = a === r ? this : this.clone(!0), ft(o[a])[e](n), rt.apply(i, n.get());
    ...
    var ne = /^(none|table(?!-c[ea]).+)/, ie = {position: "absolute", visibility: "hidden", display: "block"},
      oe = {letterSpacing: "0", fontWeight: "400"}, re = ["Webkit", "Moz", "ms"], ae = et.createElement("div").style;
    ft.extend({
      cssHooks: {
        opacity: {
          get: function (t, e) {
      ...
      ft.cssHooks[t + e] = {
        expand: function (n) {
          for (var i = 0, o = {},
                 r = "string" == typeof n ? n.split(" ") : [n]; i < 4; i++)o[t + Mt[i] + e] = r[i] || r[i - 2] || r[0];
          return o
        }
    ...
    ;ft.Animation = ft.extend(q, {
      tweeners: {
        ...
        for (var n, i = 0,
               o = t.length; i < o; i++)n = t[i], q.tweeners[n] = q.tweeners[n] || [], q.tweeners[n].unshift(e)
      ...
      valHooks: {
        option: {
          ...
          get: function (t) {
            ...
            for (var n, i, o = t.options, r = ft.makeArray(e),
                   a = o.length; a--;)i = o[a], (i.selected = ft.inArray(ft.valHooks.option.get(i), r) > -1) && (n = !0);
    ...
    ft.ajaxSetup({
      ...
      offset: function (t) {
        ...
        if (this[0]) {
          ...
          }), {top: e.top - i.top - ft.css(n, "marginTop", !0), left: e.left - i.left - ft.css(n, "marginLeft", !0)}
        }
      ...
      return w(t, [{
        ...
        key: "trigger", value: function (t) {
          if (void 0 !== this.bindings && this.bindings[t]) {
            for (var e = 0, n = arguments.length, i = Array(n > 1 ? n - 1 : 0),
                   o = 1; o < n; o++)i[o - 1] = arguments[o];
    ...
    var P = function () {
      function t(t, e) {
        ...
        try {
          for (var a,
                 s = t[Symbol.iterator](); !(i = (a = s.next()).done) && (n.push(a.value), !e || n.length !== e); i = !0);
        } catch (t) {
          o = !0, r = t
        } finally {
          try {
            ...
            if (this.enabled) {
              ...
              return document.body.scrollWidth > window.innerWidth && (E = this.cache("scrollbar-size", s), S.viewport.bottom -= E.height), document.body.scrollHeight > window.innerHeight && (E = this.cache("scrollbar-size", s), S.viewport.right -= E.width), ["", "static"].indexOf(document.body.style.position) !== -1 && ["", "static"].indexOf(document.body.parentElement.style.position) !== -1 || (S.page.bottom = document.body.scrollHeight - b - l, S.page.right = document.body.scrollWidth - m - o), void 0 !== this.options.optimizations && this.options.optimizations.moveElement !== !1 && void 0 === this.targetModifier && function () {
                ...
                if (["Top", "Left", "Bottom", "Right"].forEach(function (t) {
                  ...
                  S.offset = {top: S.page.top - n.top + l - s.top, left: S.page.left - n.left + c - s.left}
                }
...
+function (t) {
  ...
  var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
    ...
    var e = "collapse", a = "bs.collapse", s = t.fn[e], l = {toggle: !0, parent: ""},
      ...
      f = {ACTIVES: ".card > .show, .card > .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]'}, p = function () {
        function s(e, i) {
      ...
      l = {offset: "number", method: "string", target: "(string|element)"}, c = {
        ...
        return a.prototype.refresh = function () {
          var e = this, n = this._scrollElement !== this._scrollElement.window ? d.POSITION : d.OFFSET,
            i = "auto" === this._config.method ? n : this._config.method, o = i === d.POSITION ? this._getScrollTop() : 0;
    ...
    }, a = {DROPDOWN_MENU: "dropdown-menu", ACTIVE: "active", DISABLED: "disabled", FADE: "fade", SHOW: "show"}, s = {
      A: "a",
      LI: "li",
      DROPDOWN: ".dropdown",
        ...
        return s.prototype.enable = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            var l = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
              c = this._getAttachment(l), u = this.config.container === !1 ? document.body : t(this.config.container);
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (function (t) {
  ...
  if (!t.jQuery) {
    ...
    for (var o = {}, r = o.hasOwnProperty, a = o.toString,
  ...
  return function (t, e, n, i) {
    ...
    function h(t, e) {
      ...
      for (var n = b.State.calls[t][0], o = b.State.calls[t][1], r = b.State.calls[t][2], s = b.State.calls[t][4],
             l = !1, c = 0, u = n.length; u > c; c++) {
        var h = n[c].element;
    ...
    var C = function () {
      ...
      function o() {
            ...
            a(r).tweensContainer && a(r).isAnimating === !0 && (P = a(r).tweensContainer), d.each(m, function (t, e) {
              if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                ...
                if (x.RegEx.isHex.test(o)) {
                  for (var s = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), c = a ? x.Values.hexToRgb(a) : i,
                         u = 0; u < s.length; u++) {
                    var d = [l[u]];
        ...
        switch (a(r) === i && b.init(r), parseFloat(s.delay) && s.queue !== !1 && d.queue(r, s.queue, function (t) {
          b.velocityQueueEntryFlag = !0, a(r).delayTimer = {setTimeout: setTimeout(t, parseFloat(s.delay)), next: t}
  ...
  var i = n.helpers = {}, o = i.each = function (t, e, n) {
    ...
    for (var h = Math.abs(u - c), d = w(h), f = Math.ceil(u / (1 * Math.pow(10, d))) * Math.pow(10, d),
           p = i ? 0 : Math.floor(c / (1 * Math.pow(10, d))) * Math.pow(10, d), v = f - p, y = Math.pow(10, d),
           b = Math.round(v / y); (b > a || 2 * b < a) && !s;)if (b > a) y *= 2, (b = Math.round(v / y)) % 1 != 0 && (s = !0); else if (r && d >= 0) {
      if (y / 2 % 1 != 0)break;
  ...
  n.instances = {}, n.Type = function (t, e, i) {
    ...
    initialize: function () {
      ...
      if (void 0 === this.activeElements && (this.activeElements = []), function (t) {
        ...
        if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)if (this.datasets && this.datasets.length > 1) {
          for (var r, a,
                 s = this.datasets.length - 1; s >= 0 && (r = this.datasets[s].points || this.datasets[s].bars || this.datasets[s].segments, (a = l(r, t[0])) === -1); s--);
          var c = [], u = [], h = function (t) {
            ...
            }, this), s = m(d), o = g(d), r = m(h), n = g(h), {x: r > this.chart.width / 2 ? r : n, y: (s + o) / 2}
          }.call(this, a);
          new n.MultiTooltip({
            x: h.x,
            y: h.y,
    ...
    inRange: function (t, e) {
      var n = i.getAngleFromPoint(this, {x: t, y: e}), o = n.angle % (2 * Math.PI),
        r = (2 * Math.PI + this.startAngle) % (2 * Math.PI), a = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360,
    ...
    initialize: function () {
      ...
      for (var t = v(this.stepValue),
             e = 0; e <= this.steps; e++)this.yLabels.push(x(this.templateString, {value: (this.min + e * this.stepValue).toFixed(t)}));
      ...
      var e = (this.xLabelRotation, this.width - (this.xScalePaddingLeft + this.xScalePaddingRight)),
        n = e / Math.max(this.valuesCount - (this.offsetGridLines ? 0 : 1), 1), i = n * t + this.xScalePaddingLeft;
      ...
      this.display && (t.fillStyle = this.textColor, t.font = this.font, o(this.yLabels, function (o, r) {
        ...
        var i = this.calculateX(n) + b(this.lineWidth),
          o = this.calculateX(n - (this.offsetGridLines ? .5 : 0)) + b(this.lineWidth), r = this.xLabelRotation > 0,
          ...
          for (var e = this.valuesCount - 1; e >= 0; e--) {
            ...
            if (this.angleLineWidth > 0 && (n = this.calculateCenterOffset(this.max), i = this.getPointPosition(e, n), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(i.x, i.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
              ...
              var r = this.getPointPosition(0 === e ? this.valuesCount - 1 : e - 1, n),
                ...
                s = {x: (r.x + i.x) / 2, y: (r.y + i.y) / 2}, l = {x: (i.x + a.x) / 2, y: (i.y + a.y) / 2};
  ...
  e.Type.extend({
    ...
    getPointsAtEvent: function (t) {
      var e = n.getRelativePosition(t), i = n.getAngleFromPoint({x: this.scale.xCenter, y: this.scale.yCenter}, e),
...
!function (t) {
          ...
          t(".wow").each(function () {
            if ("visible" != t(this).css("visibility") && (e + n - 100 > i(this) && n < i(this) || e + n - 100 > i(this) + t(this).height() && n < i(this) + t(this).height() || e + n == t(document).height() && i(this) + 100 > t(document).height())) {
              ...
              if (a) {
                ...
                t(s).addClass("animated"), t(s).css({visibility: "visible"}), t(s).css({"animation-delay": a}), t(s).css({"animation-name": o[r]});
  ...
  return u.init = function (t) {
    ...
    for (var n, i, r = 0,
           a = t.length; r < a; r++)n = t[r], i = n.tagName.toLowerCase(), ["input", "img"].indexOf(i) !== -1 && (g[i](n), n = n.parentElement), n.className.indexOf("waves-effect") === -1 && (n.className += " waves-effect" + e)
  ...
  t(["jquery"], function (t) {
    return function () {
      ...
      function r(t, e, n) {
        return p({type: x.success, iconClass: g().iconClasses.success, message: t, optionsOverride: n, title: e})
      }

      function a(t, e, n) {
        return p({type: x.warning, iconClass: g().iconClasses.warning, message: t, optionsOverride: n, title: e})
      }
      ...
      function p(e) {
        ...
        function d() {
          clearTimeout(C), _.hideEta = 0, T.stop(!0, !0)[y.showMethod]({duration: y.showDuration, easing: y.showEasing})
        }
        ...
        if (void 0 !== e.optionsOverride && (y = t.extend(y, e.optionsOverride), x = e.optionsOverride.iconClass || x), !function (t, e) {
          ...
          w++, v = n(y, !0);
          var C = null, T = t("<div/>"), S = t("<div/>"), E = t("<div/>"), k = t("<div/>"), A = t(y.closeHtml),
...
dropdownSelectors.on({
  ...
  var vt = s(function (t, e, n) {
    ...
    Ct = w(t, "PointerEvent") !== i, Tt = xt && wt.test(navigator.userAgent), St = 25, Et = 1, kt = 2, At = 4, _t = 8,
    Pt = 1, It = 2, Dt = 4, Ot = 8, Lt = 16, Ft = It | Dt, Nt = Ot | Lt, Mt = Ft | Nt, Rt = ["x", "y"],
    Wt = ["clientX", "clientY"];
  T.prototype = {
    handler: function () {
    }, init: function () {
      ...
      e = t.extend(n, e), t(this).each(function () {
        ...
        r.on("click", function () {
          ...
          if ("touch" == i.gesture.pointerType) {
            var r = (i.gesture.direction, i.gesture.center.x), a = (i.gesture.center.y, i.gesture.velocityX, t("body")),
              l = a.innerWidth();
          ...
          if (s === !0) s = !1, a = !1, n(); else {
            ...
            i.css("overflow", "hidden"), i.width(l), t("body").append(r), "left" === e.edge ? (r.css({
              ...
              queue: !1,
              easing: "easeOutQuad"
            })) : (r.css({width: "50%", right: "", left: 0}), o.velocity({translateX: [0, e.menuWidth]}, {
              duration: 300,
              queue: !1,
              easing: "easeOutQuad"
            }));
  ...
  t(document).ready(function () {
    ...
    t(".materialize-textarea").each(function () {
      ...
      for (var e = t(this).closest(".file-field"), n = e.find("input.file-path"), i = t(this)[0].files, o = [],
             r = 0; r < i.length; r++)o.push(i[r].name);
  ...
  return e.klasses = function (t) {
    ...
    group: function (t) {
      for (var n, i = "",
             o = e._.trigger(t.min, t); o <= e._.trigger(t.max, t, [o]); o += t.i)n = e._.trigger(t.item, t, [o]), i += e._.node(t.node, n[0], n[1], n[2]);
      return i
  ...
  function n(t, e) {
    var n = this, i = t.$node[0], o = i.value, r = t.$node.data("value"), a = r || o, s = r ? e.formatSubmit : e.format,
      l = function () {
  ...
  function i(i, a) {
    ...
    var u = r(T), h = u.find(".clockpicker-plate"), g = u.find(".picker__holder"), m = u.find(".clockpicker-hours"),
      S = u.find(".clockpicker-minutes"), E = u.find(".clockpicker-am-pm-block"), k = "INPUT" === i.prop("tagName"),
      A = k ? i : i.find("input"), _ = r("label[for=" + A.attr("id") + "]"), P = this;
  ...
  return function (t, e, n, i) {
    ...
    o.extend(a, i);
    var s, l, c, u, h, d, f, p, g, m, v, y, b, w, x, C, T, S, E, k, A, _, P, I, D, O, L, F, N, M, R, W, H, j, z, V, B,
      q, Y, X, $, U, Q, G, Z, K, J, tt, et, nt, it, ot, rt, at, st, lt, ct = function () {
        return {x: 0, y: 0}
      }, ut = ct(), ht = ct(), dt = ct(), ft = {}, pt = 0, gt = {}, mt = ct(), vt = 0, yt = !0, bt = [], wt = {}, xt = !1,
      Ct = function (t, e) {
        ...
        shout: kt, listen: Et, viewportSize: ft, options: a, isMainScrollAnimating: function () {
          ...
          if (ft.x = r.scrollWrap.clientWidth, ft.y = r.scrollWrap.clientHeight, Ut(), mt.x = ft.x + Math.round(ft.x * a.spacing), mt.y = ft.y, Lt(mt.x * pt), kt("beforeResize"), void 0 !== d) {
            for (var i, s, l,
                   c = 0; 3 > c; c++)i = C[c], Ot((c + d) * mt.x, i.el.style), l = u + c - 1, a.loop && Qe() > 2 && (l = Tt(l)), s = Ue(l), s && (x || s.needsUpdate || !s.bounds) ? (r.cleanSlide(s), r.setContent(i, l), 1 === c && (r.currItem = s, r.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === i.index && l >= 0 && r.setContent(i, l), s && s.container && (on(s, ft), ln(s), Dt(s));
            x = !1
          }
    ...
    var qe, Ye, Xe, $e, Ue, Qe, Ge, Ze = function (e, n, i, s) {
      ...
      if (Je.length) {
        for (var t,
               e = 0; e < Je.length; e++)t = Je[e], t.holder.index === t.index && rn(t.index, t.item, t.baseDiv, t.img, 0, t.clearPlaceholder);
        Je = []
      }
    };
    Ct("Controller", {
      publicMethods: {
        lazyLoadItem: function (t) {
          ...
          o.extend(a, tn, !0), r.items = Ye = n, Ue = r.getItemAt, Qe = a.getNumItemsFn, Ge = a.loop, Qe() < 3 && (a.loop = !1), Et("beforeChange", function (t) {
            ...
            for (var t,
                   e = 0; e < Ye.length; e++)t = Ye[e], t.container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
            Je = null
          })
  ...
  return function (t, e) {
    var n, i, o, r, a, s, l, c, u, h, d, f, p, g, m, v, y, b, w, x = this, C = !1, T = !0, S = !0, E = {
      ...
      for (var n, i, o = t.target || t.srcElement, r = o.getAttribute("class") || "",
             a = 0; a < q.length; a++)n = q[a], n.onTap && r.indexOf("pswp__" + n.name) > -1 && (n.onTap(), i = !0);
      if (i) {
      ...
      for (var t, e, n, i, o, r = "",
             a = 0; a < m.shareButtons.length; a++)t = m.shareButtons[a], n = m.getImageURLForShare(t), i = m.getPageURLForShare(t), o = m.getTextForShare(t), e = t.url.replace("{{url}}", encodeURIComponent(i)).replace("{{image_url}}", encodeURIComponent(n)).replace("{{raw_image_url}}", n).replace("{{text}}", encodeURIComponent(o)), r += '<a href="' + e + '" target="_blank" class="pswp__share--' + t.id + '"' + (t.download ? "download" : "") + ">" + t.label + "</a>", m.parseShareButtonOut && (r = m.parseShareButtonOut(t, r))
      ;
...
var initPhotoSwipeFromDOM = function (t) {
  for (var e = function (t) {
      for (var e, n, i, o, r = t.childNodes, a = r.length, s = [],
             l = 0; l < a; l++)e = r[l], 1 === e.nodeType && (n = e.children[0], i = n.getAttribute("data-size").split("x"), o = {
      ...
      if (i) {
        for (var r, a = i.parentNode, s = i.parentNode.childNodes, l = s.length, c = 0,
               u = 0; u < l; u++)if (1 === s[u].nodeType) {
          if (s[u] === i) {
            r = c;
            break
          }
      ...
      if (s = e(n), a = {
          galleryUID: n.getAttribute("data-pswp-uid"), getThumbBoundsFn: function (t) {
            var e = s[t].el.getElementsByTagName("img")[0], n = window.pageYOffset || document.documentElement.scrollTop,
    ...
    }, r = document.querySelectorAll(t), a = 0,
         s = r.length; a < s; a++)r[a].setAttribute("data-pswp-uid", a + 1), r[a].onclick = i;
  var l = function () {
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (t) {
  t.fn.sticky = function (e) {
    ...
    return this.each(function () {
      ...
      var n = t(this), a = n.outerHeight(), s = n.outerWidth(), l = i.topSpacing, c = i.zIndex, u = n.offset().top - l,
        h = t("<div></div>").width(s).height(a).addClass("sticky-placeholder"), d = i.stopper, f = t(window);
      f.bind("scroll", e)
    })
  }
}(jQuery), function t(e, n, i) {
      ...
      e.event.bind(e.ownerDocument, "keydown", function (c) {
        if (!(c.isDefaultPrevented && c.isDefaultPrevented() || c.defaultPrevented)) {
          ...
          if (i || u) {
            ...
            l(t, "top", t.scrollTop - f), l(t, "left", t.scrollLeft + d), s(t), (a = n(d, f)) && c.preventDefault()
          }
        }
      })
    }
  ...
  13: [function (t, e, n) {
    ...
    function i(t, e) {
      ...
      function i(t) {
        ...
        return void 0 !== e && void 0 !== n || (e = -1 * t.wheelDeltaX / 6, n = t.wheelDeltaY / 6), t.deltaMode && 1 === t.deltaMode && (e *= 10, n *= 10), e !== e && n !== n && (e = 0, n = t.wheelDelta), [e, n]
      }
  ...
  20: [function (t, e, n) {
    "use strict"
    ;var i, o, r = t("./instances"), a = document.createEvent("Event"), s = document.createEvent("Event"),
      ...
      p = document.createEvent("Event"), g = document.createEvent("Event");
  ...
  Prism = function () {
    var t = /\blang(?:uage)?-(\w+)\b/i, e = 0, n = _self.Prism = {
      util: {
        ...
        for (var o, r = i.elements || document.querySelectorAll(i.selector),
               a = 0; o = r[a++];)n.highlightElement(o, t === !0, i.callback)
          ...
          for (var l = 0; l < s.length; ++l) {
            ...
            for (var g = 0; g < o.length; g++) {
              ...
              if (!(m instanceof i)) {
                ...
                if (v) {
                  h && (f = v[1].length);
                  var x = v.index + f, v = v[0].slice(f), C = x + v.length, S = m.slice(0, x), E = m.slice(C),
                    k = [g, y];
                  S && k.push(S);
...
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    Q = new RegExp("^flash-(" + U.map(function (t) {
      ...
      if (t && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(t.type)) {
        var n = t.target, i = "_mouseover" === t.type && t.relatedTarget ? t.relatedTarget : e,
          ...
          u = a.body.scrollLeft + a.documentElement.scrollLeft, h = a.body.scrollTop + a.documentElement.scrollTop,
          d = s.left + ("number" == typeof t._stageX ? t._stageX : 0),
          f = s.top + ("number" == typeof t._stageY ? t._stageY : 0), p = d - u, g = f - h, m = l + p, v = c + g,
          y = "number" == typeof t.movementX ? t.movementX : 0, b = "number" == typeof t.movementY ? t.movementY : 0;
      ...
      if (t.getBoundingClientRect) {
        var n = t.getBoundingClientRect(), i = r.pageXOffset, o = r.pageYOffset, s = a.documentElement.clientLeft || 0,
          l = a.documentElement.clientTop || 0, c = 0, u = 0;
  ...
  var te = function (t) {
    var e = this;
    e.id = "" + Qt++, Gt[e.id] = {instance: e, elements: [], handlers: {}}, t && e.clip(t), Ut.on("*", function (t) {
      return e.emit(t)
    ...
    var e = Gt[this.id], n = e && e.elements, i = !!n && n.length > 0, o = !t.target || i && -1 !== n.indexOf(t.target),
    ...
    if (t && 1 === t.nodeType) {
      ...
      if ("object" == typeof e && e) {
        for (var n, i, o = ["move", "leave", "enter", "out", "over"], r = 0,
               a = o.length; a > r; r++)n = "mouse" + o[r], "function" == typeof(i = e[n]) && t.removeEventListener(n, i, !1);
